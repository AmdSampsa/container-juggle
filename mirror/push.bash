...
rsync -e "ssh -p $sshport -o StrictHostKeyChecking=no" -uvr --exclude "**/.*" --include="*.py" --include "*.txt" --include "*.json" --include "*.md"  --include="*/" --exclude="*" $HOME/shared/tests/ $username@$hostname:shared/tests/ & \
