...
rsync -e "ssh -p $sshport -o StrictHostKeyChecking=no -o BatchMode=yes" --delete -uvr --exclude "**/.*" --include="*.py" --include "*.txt" --include "*.csv" --include "*.json" --include "*.md" --include "*.bash" --include="*/" --exclude="*" $HOME/shared/tests/ $username@$hostname:shared/tests/ & \
